...
export const ACADEMIC_DOMAINS: AcademicDomainSeed[] = [
  ...
  },
  {
    ...
    description: "Production scientifique, laboratoires, événements et transfert.",
    order: 10,
    disciplines: [
      { id: 1001, name: "Publications", slug: "publications", order: 1 },
      { id: 1002, name: "Projets de Recherche", slug: "projets-de-recherche", order: 2 },
      { id: 1003, name: "Laboratoires", slug: "laboratoires", order: 3 },
      { id: 1004, name: "Conférences", slug: "conferences", order: 4 },
      { id: 1005, name: "Innovation", slug: "innovation", order: 5 },
    ],
  },
];
