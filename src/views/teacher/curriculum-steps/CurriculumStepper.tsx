...
export default function CurriculumStepper(props: Props) {
  const { activeCurriculumStep, setActiveCurriculumStep, curriculumSuccessMsg, curriculumErrorMsg, managedCourse, managedCourses, newSectionCourseId, showCurriculumSuccess, showCurriculumError, handleSelectManagedCourse, loadTeacherQuizzes } = props;
