/** Dark live control console — unified green palette */
export const liveControlUi = {
  page: "animate-in fade-in duration-300 space-y-6",
  shell:
    "relative overflow-hidden rounded-3xl border border-emerald-500/25 bg-[#0a1f1a] p-5 shadow-2xl shadow-emerald-950/30 sm:p-6 md:p-8",
  shellGlow:
    "pointer-events-none absolute inset-0 rounded-3xl bg-gradient-to-br from-emerald-500/10 via-teal-500/5 to-transparent",
  ...
  heroIcon:
    "flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 shadow-lg shadow-emerald-900/40",
  ...
  section: "relative z-10 space-y-3 rounded-2xl border border-white/[0.08] bg-[#0a1f1a]/90 p-4 sm:p-5",
  sectionHead: "flex items-start gap-3",
  sectionIconPink:
    "flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500/20 to-teal-600/20 border border-emerald-500/20",
  sectionIconGreen:
  ...
  select:
    "w-full appearance-none rounded-xl border border-white/[0.08] bg-[#031512] py-3.5 pl-10 pr-10 text-xs font-semibold text-slate-100 transition-all focus:border-emerald-500/40 focus:outline-none focus:ring-4 focus:ring-emerald-500/10",
  input:
    "w-full rounded-xl border border-white/[0.08] bg-[#031512] py-3.5 pl-10 pr-4 text-xs font-semibold text-slate-100 placeholder:text-slate-600 transition-all focus:border-emerald-500/40 focus:outline-none focus:ring-4 focus:ring-emerald-500/10",
  ...
  broadcastCard: "relative z-10 rounded-2xl border border-white/[0.08] bg-[#0a1f1a]/90 p-4 sm:p-5",
  liveBadge:
  ...
  startBtn:
    "inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 px-5 py-3 text-xs font-black text-white shadow-lg shadow-emerald-900/25 transition-all hover:from-emerald-500 hover:to-teal-500 active:scale-[0.98]",
  enterBtn:
  ...
  roomShell:
    "live-room-shell flex h-[min(78dvh,820px)] min-h-[480px] w-full flex-col overflow-hidden rounded-none border-y border-white/[0.08] lg:rounded-2xl lg:border",
} as const;
