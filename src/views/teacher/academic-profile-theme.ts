...
export const profileUi = {
  ...
  heroGlowIndigo: "pointer-events-none absolute -right-24 -top-24 h-64 w-64 rounded-full bg-indigo-500/20 blur-3xl",
  heroGlowViolet: "pointer-events-none absolute -left-16 bottom-0 h-48 w-48 rounded-full bg-violet-500/15 blur-3xl",
  ...
  card: "overflow-hidden rounded-2xl sm:rounded-3xl border border-white/[0.08] bg-[#0f172a]/80 shadow-xl shadow-black/25 backdrop-blur-xl transition-shadow duration-300 hover:shadow-2xl hover:shadow-black/30",
  ...
  inputIcon: "pointer-events-none absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-indigo-400/80",
