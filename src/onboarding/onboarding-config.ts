...
const studentSteps: OnboardingStep[] = [
  {
    ...
    targetSelectors: ["#nav-dashboard", "#sidebar-category-studies"],
    placement: "right",
  ...
  },
  {
    ...
    targetSelectors: ["#nav-catalog", "#sidebar-category-studies"],
    placement: "right",
    requiresSidebar: true,
    view: "catalog",
  },
  ...
  },
  {
    ...
    targetSelectors: ["#nav-notifications", "#sidebar-category-communication"],
    placement: "right",
    requiresSidebar: true,
    view: "notifications",
  },
...
const teacherSteps: OnboardingStep[] = [
  {
    ...
    targetSelectors: ["#nav-teacher-dashboard", "#sidebar-category-pilotage"],
    placement: "right",
    requiresSidebar: true,
    view: "dashboard",
  },
  {
    ...
    targetSelectors: ["#nav-curriculum", "#sidebar-category-teaching"],
    placement: "right",
    requiresSidebar: true,
    view: "curriculum",
  },
  ...
  },
  {
    ...
    targetSelectors: ["#nav-live-control", "#sidebar-category-teaching"],
    placement: "right",
    requiresSidebar: true,
    view: "live-control",
  },
