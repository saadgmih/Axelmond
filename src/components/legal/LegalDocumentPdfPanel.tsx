      ...
      <div className="flex flex-col gap-4 border-b border-slate-800/80 bg-slate-900/70 px-4 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-5">
        ...
        <div className="flex shrink-0 items-center gap-2">
          <a
            ...
            className="inline-flex min-h-11 items-center justify-center gap-2 rounded-2xl border border-slate-700 bg-slate-900 px-4 text-xs font-black text-slate-100 transition-colors hover:border-violet-500/50 hover:bg-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-400"
          >
          ...
          <button
            type="button"
            onClick={onClose}
            className="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-slate-700 bg-slate-900 text-slate-300 transition-colors hover:border-rose-500/50 hover:bg-rose-500/10 hover:text-rose-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-400"
