...
const RuleCard: React.FC<{
  ...
  <div className={`rounded-2xl border p-5 space-y-3 ${border} ${bg} hover:scale-[1.02] transition-transform duration-200`}>
  ...
  return (
    <div className="min-h-full bg-slate-950 text-white">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
            ...
            <div className="space-y-5 max-w-2xl">
              ...
              <p className="text-slate-400 text-sm md:text-base leading-relaxed">
                En accédant à la plateforme <strong className="text-white">Axelmond Research Labs</strong>,
                vous acceptez les présentes conditions dans leur intégralité. Elles régissent l'ensemble de vos
                interactions avec la plateforme, ses services et sa communauté académique.
              </p>
            ...
            {/* Right meta card */}
            <div className="bg-slate-900/80 border border-slate-800 rounded-2xl p-5 space-y-4 flex-shrink-0 min-w-[220px]">
          ...
          <div className="mt-8 bg-slate-900/60 border border-slate-800 rounded-2xl px-5 py-4 flex items-start gap-3">
            ...
            <p className="text-[12px] text-slate-400 leading-relaxed">
              <strong className="text-violet-300">Acceptation :</strong> La création d'un compte ou la simple
              navigation sur les pages protégées de la plateforme vaut acceptation pleine et entière des
              présentes conditions d'utilisation. En cas de désaccord, veuillez cesser toute utilisation
              de la plateforme et contacter <strong className="text-white">verification@axelmond.com</strong>.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-10 py-10 space-y-8">
        ...
        <div ref={s1.ref}>
          <SectionBlock
            number="01" title="Règles générales"
          ...
          >
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <RuleCard
                ...
                border="border-indigo-800/30" bg="bg-indigo-950/20"
              />
              <RuleCard
                ...
                border="border-violet-800/30" bg="bg-violet-950/20"
              />
              <RuleCard
        ...
        <div ref={s2.ref}>
          <SectionBlock
            number="02" title="Responsabilité du compte"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-amber-950/20 border border-amber-800/30 rounded-2xl p-5 space-y-3 self-start">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-amber-300 text-xs font-black uppercase tracking-wide">Avertissement important</span>
                </div>
                <p className="text-[12px] text-slate-300 leading-relaxed">
                  Axelmond Research Labs ne vous demandera <strong className="text-white">jamais</strong> votre
                  mot de passe par e-mail, chat ou téléphone. Méfiez-vous de toute demande en ce sens.
                  Tout incident de sécurité doit être rapporté sans délai.
                </p>
                <div className="pt-1 border-t border-amber-800/30">
                  <div className="text-[10px] uppercase tracking-widest text-amber-600 font-bold mb-1">Contact sécurité</div>
        ...
        <div ref={s3.ref}>
          <SectionBlock
            number="03" title="Intégrité académique"
            icon={<GraduationCap className="w-5 h-5 text-pink-300" />}
            accentClass="bg-pink-500/15 border border-pink-500/20"
            inView={s3.inView}
          >
            <p className="text-[13px] text-slate-400 leading-relaxed mb-5">
              La plateforme est un environnement académique exigeant. L'intégrité dans les évaluations,
              les travaux et la recherche est une condition non négociable de l'accès aux services.
            </p>
              ...
              {[
                {
                  ...
                  border: "border-red-900/30", bg: "bg-red-950/15",
                },
                {
                  ...
                  border: "border-amber-900/30", bg: "bg-amber-950/15",
                },
                {
                  icon: <XCircle className="w-4 h-4 text-red-400" />,
                ...
                },
                {
                  ...
                  border: "border-emerald-900/30", bg: "bg-emerald-950/15",
                },
              ].map(({ icon, title, desc, border, bg }) => (
                <div key={title} className={`rounded-2xl border p-5 space-y-2.5 ${border} ${bg} hover:scale-[1.01] transition-transform duration-200`}>
        ...
        <div ref={s4.ref}>
          <SectionBlock
            number="04" title="Utilisation acceptable"
            icon={<AlertOctagon className="w-5 h-5 text-red-300" />}
            accentClass="bg-red-500/15 border border-red-500/20"
            inView={s4.inView}
          >
            <p className="text-[13px] text-slate-400 leading-relaxed mb-5">
              Les comportements suivants sont strictement interdits sur la plateforme et entraînent une
              suspension immédiate du compte.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="bg-slate-950/50 border border-slate-800 rounded-2xl p-5 space-y-3">
                <div className="text-[10px] uppercase tracking-widest text-red-400 font-black mb-1">Infrastructure & Sécurité</div>
                <ForbidList items={[
              ...
              <div className="bg-slate-950/50 border border-slate-800 rounded-2xl p-5 space-y-3">
                <div className="text-[10px] uppercase tracking-widest text-red-400 font-black mb-1">Contenu & Comportement</div>
                <ForbidList items={[
        ...
        <div ref={s5.ref}>
          <SectionBlock
            number="05" title="Sécurité et protection"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                },
                {
                  ...
                  border: "border-amber-800/30", bg: "bg-amber-950/20",
                },
              ].map(({ icon, title, desc, border, bg }) => (
                <div key={title} className={`rounded-2xl border p-4 space-y-2.5 ${border} ${bg} hover:-translate-y-0.5 transition-transform duration-200`}>
                  <div className="w-8 h-8 rounded-xl bg-slate-900/60 flex items-center justify-center">{icon}</div>
                  <div className="text-white text-sm font-bold">{title}</div>
          ...
          >
            ...
            <div className="relative p-7 md:p-9">
              ...
              <p className="text-[13px] text-slate-400 leading-relaxed mb-6">
                Le non-respect des présentes conditions expose l'utilisateur aux sanctions suivantes,
                appliquées progressivement selon la gravité et la récidive constatées.
              </p>
                ...
                {[
                  ...
                  <div key={level} className={`rounded-2xl border p-4 space-y-2.5 ${color}`}>
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span className={`text-[10px] font-black uppercase tracking-widest border px-2.5 py-1 rounded-full ${chip}`}>{level}</span>
                    </div>
              ...
              <div className="bg-slate-900/60 border border-slate-800 rounded-2xl px-5 py-4 flex items-start gap-3">
                ...
                <p className="text-[12px] text-slate-400">
                  ...
                  contester la décision dans un délai de <strong className="text-white">14 jours</strong> en écrivant
                  à <strong className="text-indigo-300">verification@axelmond.com</strong>. Une réponse motivée sera
        ...
        <div ref={s7.ref}>
          <SectionBlock
            number="07" title="Propriété intellectuelle"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="space-y-4">
                <p className="text-[13px] text-slate-300 leading-relaxed">
                  L'ensemble des contenus publiés sur la plateforme — modules, publications, vidéos, documents,
                  supports pédagogiques, interfaces et code source — est protégé par le droit de la propriété
              ...
              <div className="space-y-3">
                <div className="bg-red-950/20 border border-red-800/30 rounded-2xl p-5 space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-red-300 text-xs font-black uppercase tracking-wide">Strictement interdits</span>
                  </div>
                  <ForbidList items={[
        ...
        <div ref={s8.ref}>
          <SectionBlock
            number="08" title="Disponibilité du service"
          ...
          >
            ...
            <p className="text-[13px] text-slate-300 leading-relaxed mb-4">
              La plateforme peut être temporairement indisponible dans les cas suivants, sans que cela
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={item} className="flex items-start gap-2.5 bg-slate-900/40 border border-slate-800 rounded-xl px-4 py-3">
        ...
        <div ref={s9.ref}>
          <SectionBlock
            number="09" title="Modifications des conditions"
          ...
          >
            <p className="text-[13px] text-slate-300 leading-relaxed mb-5">
              Axelmond Research Labs se réserve le droit de modifier les présentes conditions à tout moment,
              afin de refléter les évolutions de la plateforme, les obligations légales ou les changements
              de pratiques du secteur académique numérique.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                {
                ...
                <div key={step} className="bg-slate-950/50 border border-slate-800 rounded-2xl p-5 space-y-3">
                  <div className={`text-[10px] font-black tabular-nums ${color} uppercase tracking-widest`}>Étape {step}</div>
                  <div className="text-white text-sm font-bold">{title}</div>
                  <p className="text-[12px] text-slate-400 leading-relaxed">{desc}</p>
                </div>
              ))}
            ...
            <p className="text-[12px] text-slate-600 mt-4">
              La version en vigueur des conditions est toujours accessible depuis le pied de page du portail.
              En cas de contradiction entre une version antérieure et la version actuelle, la version actuelle prévaut.
            </p>
          </SectionBlock>
        </div>
        ...
        <div ref={s10.ref}>
          ...
          >
            <div className="p-7 md:p-9">
              <SectionHeading
                number="10" title="Informations légales"
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-3">
                  {[
                    { label: "Politique de confidentialité", view: "privacy", color: "text-indigo-300 border-indigo-500/30 bg-indigo-500/10 hover:bg-indigo-500/20" },
                    { label: "Politique des cookies",        view: "cookies", color: "text-violet-300 border-violet-500/30 bg-violet-500/10 hover:bg-violet-500/20" },
                    { label: "Centre d'aide",                view: "support", color: "text-emerald-300 border-emerald-500/30 bg-emerald-500/10 hover:bg-emerald-500/20" },
                    { label: "Contact",                      view: "contact", color: "text-sky-300 border-sky-500/30 bg-sky-500/10 hover:bg-sky-500/20" },
                  ].map(({ label, color }) => (
              ...
              <div className="mt-6 bg-slate-950/40 border border-slate-800/60 rounded-2xl px-5 py-4 flex items-start gap-3">
                ...
                <p className="text-[12px] text-slate-400 leading-relaxed">
                  Pour toute question juridique relative à ces conditions ou pour exercer vos droits,
                  écrivez à <strong className="text-white">verification@axelmond.com</strong> avec
                  pour objet <em className="text-rose-300">«&nbsp;Question juridique — CGU&nbsp;»</em>.
