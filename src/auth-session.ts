...
import type { setAuthCookies, persistCsrfTokenForRefreshSession } from "./auth-cookies";
...
export type AuthSessionApi = {
  ...
  persistCsrfTokenForRefreshSession: typeof persistCsrfTokenForRefreshSession;
...
export async function issueAuthenticatedSession(
  ...
  await api.persistCsrfTokenForRefreshSession(refreshToken, csrfToken);
