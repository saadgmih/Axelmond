export const directorProfile = {
  name: "Pr. Oussama El Abboudi",
  title: "Directeur de Performance Académique",
  shortTitle: "Directeur",
  ...
  photo: "/director-oussama-el-abboudi.jpg",
  fullPhoto: "/director-oussama-el-abboudi-full.jpg",
