...
append_if_missing "HOSTINGER_WEBAPP" "1"
append_if_missing "SKIP_PRISMA_POSTINSTALL" "1"
append_if_missing "GRACEFUL_SHUTDOWN_MS" "5000"

grep -E '^(HEALTH_CHECK_TOKEN|CACHE_MAX_ENTRIES|CACHE_MAX_VALUE_BYTES|AUTH_USER_CACHE_MAX_ENTRIES|PERF_MONITOR_INTERVAL_MS|HOSTINGER_WEBAPP|SKIP_PRISMA_POSTINSTALL|GRACEFUL_SHUTDOWN_MS)=' "$ENV_FILE"
date +%s > "$RESTART_FILE"
