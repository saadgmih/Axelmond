...
rulesTest("rbac", () => {
  ...
  assert.equal(canAccessApiRoute("STUDENT", "GET", "/api/users/professor-1/profile"), true);
  assert.equal(canAccessApiRoute("PROFESSOR", "GET", "/api/users/student-1/profile"), true);
  assert.equal(canAccessApiRoute("ADMIN", "DELETE", "/api/users/student-1/profile"), false);
  assert.equal(canAccessApiRoute("STUDENT", "PUT", "/api/me/user-profile"), true);
  assert.equal(canAccessApiRoute("PROFESSOR", "PUT", "/api/me/user-profile"), true);
  assert.equal(canAccessApiRoute("ADMIN", "GET", "/api/me/user-profile"), false);
  ...
  assert.equal(canAccessApiRoute("STUDENT", "POST", "/api/livekit/attendance/leave"), true);
  assert.equal(canAccessApiRoute("STUDENT", "GET", "/api/livekit/attendance/1"), false);
  assert.equal(canAccessApiRoute("PROFESSOR", "GET", "/api/livekit/attendance/1"), true);
  assert.equal(canAccessApiRoute("ADMIN", "GET", "/api/livekit/attendance/1"), true);
  ...
  assert.equal(isRbacExemptRoute("GET", "/api/admin/professor-invites"), false);
  assert.equal(canAccessApiRoute("ADMIN", "GET", "/api/admin/professor-invites"), true);
  assert.equal(canAccessApiRoute("PROFESSOR", "GET", "/api/admin/professor-invites"), false);
  assert.equal(canAccessApiRoute("STUDENT", "GET", "/api/admin/professor-invites"), false);
  ...
  assert.equal(canAccessApiRoute("STUDENT", "POST", "/api/chat-tutor"), false);
