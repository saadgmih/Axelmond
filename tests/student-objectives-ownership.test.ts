...
const v2MigrationSource = fs.readFileSync("prisma/migrations/20260611031500_student_productivity_v2/migration.sql", "utf8");
...
assert.match(serverSource, /app\.get\("\/api\/me\/objectives\/summary"/);
